...
builder.Services.AddAuthentication(options =>
    ...
    {
        googleOptions.ClientId = builder.Configuration["Authentification:Google:ClientId"];
        googleOptions.ClientSecret = builder.Configuration["Authentification:Google:ClientSecret"];
    })
    .AddIdentityCookies();
